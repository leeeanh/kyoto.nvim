...
M.config = function()
  ...
  lualine_config.options = config.options
  lualine_config.builtin.lualine.sections = config.sections
  lualine_config.builtin.lualine.inactive_sections = config.inactive_sections
end
